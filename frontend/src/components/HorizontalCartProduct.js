...

                {
                    loading ? (
                        loadingList.map((product, index) => (
                            <div key={index} className='min-w-[280px] md:min-w-[320px] max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                        ...
                        (
                            ...
                            data.map((product, index) => (
                                <Link key={index} to={"product/" + product?._id} className='min-w-[280px] md:min-w-[320px] max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
