                ...
                {/* Product Details */}
                {
                    loading ? (
                        <div className=' grid w-full gap-1'>
                            ...
                            <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1 h-6 lg:h-8 bg-slate-200 animate-pulse rounded-full w-full'>
                                <p className='text-red-600 bg-slate-200 h-6 lg:h-8 rounded-full w-full'></p>
                                <p className='text-slate-400  bg-slate-200 h-6 lg:h-8 rounded-full w-full'></p>
                            </div>
                            <div className='flex items-center gap-3 my-2'>
                                <button className='h-6 lg:h-8 bg-slate-200 animate-pulse rounded-full w-full '></button>
                                <button className='h-6 lg:h-8 bg-slate-200 animate-pulse rounded-full w-full '></button>
                            </div>
                            <div className='w-full'>
                                <p className='text-slate-600 font-medium my-1 h-6 lg:h-8 bg-slate-200 animate-pulse rounded-full w-full'>

                                </p>
                                <p className='h-10 bg-slate-200 animate-pulse rounded-full w-full lg:h-12'></p>
                            </div>
                        </div>
                    ) : (
                        <div className='flex flex-col grid-col gap-1'>
